...
$catch_roll_book = mysqli_query($my_db, "SELECT user_name, a_id AS user_id, b_id AS roll_check
                                         FROM User_table
                                         RIGHT OUTER JOIN (
                                            ...
                                            FROM (SELECT *
                                                  ...
                                                  LEFT OUTER JOIN (SELECT l_id, check_date, user_id
...
while($data = mysqli_fetch_array($catch_roll_book)){
    ...
    $send_roll_book .= $data['user_name'] . "∥" . $data['user_id']. "∥";
    if($data['roll_check'] == "")
    {
        $send_roll_book .= "M";
    }
